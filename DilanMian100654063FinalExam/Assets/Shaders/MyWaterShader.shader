Shader "Custom/MyWaterShader"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf Standard fullforwardshadows//this allows the shader to have shadows
        #pragma vertex vert
        ...
        void vert(inout appdata_full i) {//this controls the range values for the structure of the wave variables
            float displacement = _WaveAmplitude * sin((i.vertex.x + _Time.x * _WaveSpeed) * _WaveFrequency);//This is the wav sin function
            if (displacement > 0) {
                displacement = 1;
            }
